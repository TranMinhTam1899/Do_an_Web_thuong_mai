...
<body>
    ...
    <div class="body-wrapper">
        ...
        <header>
            ...
            <div class=" header-middle pl-sm-0 pr-sm-0 pl-xs-0 pr-xs-0 pt-30 pt-30 mt-40">
                <div class="container">
                    <div class="row">
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-9 order-1 order-lg-2">
                        ...
                        <!-- Main content -->
                        <div class="shop_main_content mt-20 bg-white">
                    ...
                    <div class="col-lg-3 order-2 order-lg-1">
                        ...
                        <div class="sidebar-categores-box mt-sm-30 mt-xs-30">
                            <div class="sidebar-title">
                                <h2 class="text-center">Shop Cây Chuối</h2>
                            </div>
                            <!-- category-sub-menu start -->
                            <div class="category-sub-menu">
                                <ul>
                                    <li class="has-sub"><a href="# ">Quản lý đơn hàng</a>
                                        <ul>
                                            <li><a href="#">Xử lý đơn hàng</a></li>
                                        </ul>
                                    </li>
                                    <li class="has-sub"><a href="#">Quản lý sản phẩm</a>
                                        <ul>
                                            <li><a href="#">Danh sách sản phẩm</a></li>
                                            <li><a href="#">Thêm sản phẩm</a></li>
                                        </ul>
                                    </li>
                                    <li class="has-sub"><a href="#">Kênh quảng cáo</a>
                                        <ul>
                                            <li><a href="#">Quảng cáo của tôi</a></li>
                                        </ul>
                                    </li>
                                    <li class="has-sub"><a href="#">Quản lý shop</a>
                                        <ul>
                                            <li><a href="#">Đánh giá shop</a></li>
                                            <li><a href="#">Trang trí shop</a></li>
                                            <li><a href="#">Báo cáo của tôi</a></li>
                                            <li><a href="#">Cập nhật thông tin tài khoản</a></li>
                                            <li><a href="#">Đánh giá shop</a></li>
                                            <li><a href="#">Cập nhật thông tin shop</a></li>
                                        </ul>
                                    </li>
                                </ul>
                            </div>
